...
if (text.length > 55) return m.reply('𝙈𝘼𝙓𝙄𝙈𝙊 55 𝙋𝘼𝙇𝘼𝘽𝙍𝘼𝙎!')
try {
...
if (stiker) return conn.sendFile(m.chat, stiker, 'sticker.webp', '',m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: wm, body: `h`, mediaType: 2, sourceUrl: nn, thumbnail: imagen4}}}, { quoted: m })

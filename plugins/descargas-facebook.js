...
if (!args[0]) return await conn.reply(m.chat,  `${lenguajeGB['smsAvisoMG']()}𝙄𝙣𝙜𝙧𝙚𝙨𝙚 𝙪𝙣 𝙚𝙣𝙡𝙖𝙘𝙚 𝙙𝙚 𝙁𝙖𝙘𝙚𝙗𝙤𝙤𝙠 𝙥𝙖𝙧𝙖 𝙙𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙧 𝙚𝙡 𝙑𝙞𝙙𝙚𝙤\n𝙀𝙟:\n${usedPrefix + command} https://www.facebook.com/watch?v=636541475139`, fkontak, {contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: '', previewType: 0, thumbnail: imagen4, sourceUrl: redes.getRandom()}}}) 
...
try {
await conn.reply(m.chat, `${lenguajeGB['smsAvisoEG']()}*⌛ 𝘾𝙖𝙡𝙢𝙖 ✋ 𝘾𝙡𝙖𝙘𝙠, 𝙔𝙖 𝙚𝙨𝙩𝙤𝙮 𝙙𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙙𝙤 𝙨𝙪 𝙫𝙞𝙙𝙚𝙤 𝙙𝙚 𝙁𝙖𝙘𝙚𝙗𝙤𝙤𝙠 ⌛*`, fkontak, {contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: `${wm}`, body: '', previewType: 0, thumbnail: imagen4, sourceUrl: redes.getRandom()}}}) 
